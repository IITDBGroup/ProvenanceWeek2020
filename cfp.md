...
Papers must be:
+ not published or under review elsewhere
+ we invite long papers (8 pages excluding references and appendix) and short papers (4 pages excluding references and appendix) following [USENIX format](https://www.usenix.org/conferences/author-resources/paper-templates).
